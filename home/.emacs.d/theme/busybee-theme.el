...
(custom-theme-set-faces
  'busybee 
	...
	'(org-hide ((t (:foreground "#708090"))))
        '(org-level-1 ((t (:bold t :foreground "#808080" :underline t :height 1.2))))
        ;; '(org-level-2 ((t (:bold t :foreground "#7e8aa2" :underline t :height 1.1))))
        '(org-level-2 ((t (:bold t :foreground "#00aaaa" :underline t :height 1.1))))
        '(org-level-3 ((t (:bold t :foreground "#df9f2d" :underline t :height 1.0))))
        '(org-level-4 ((t (:bold t :foreground "#af4f4b" :underline t))))
